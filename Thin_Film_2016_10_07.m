...
Thickness = 10; % thickness in um
h=[NaN,Thickness*1000,NaN]; %film thicknesses in nm, equal in length to n, start and end with NaN
...
axis tight;
% title('Transmission/Absorption for thin HDPE film');
title('\fontsize{16}Transmission/Absorption for thin {\color{red}HDPE} film.');

legend('Transmission','Absorption','Reflection');

grid on;
text(200,0.5,['\fontsize{16}THz polarization = ' POLARIZATION]);
text(200,0.6,['HDPE, Thickness = ' num2str(Thickness) 'um, n = 1.54']);